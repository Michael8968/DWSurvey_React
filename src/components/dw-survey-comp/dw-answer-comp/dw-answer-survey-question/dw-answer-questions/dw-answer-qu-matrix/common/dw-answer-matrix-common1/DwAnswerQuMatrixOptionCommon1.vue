        ...
        <table>
          <thead>
            ...
            <tr class="dw-el-radio-checkbox-tr">
              <template v-for="(colOption) in survey.questions[index].quCols">
                <td v-if="!colOption.tempEmptyOption" :key="`col_${colOption.dwId}`" class="matrix-title-td">
          ...
          <tbody v-for="(rowOption, rowOptionIndex) in survey.questions[index].quRows" :key="`matrix-rowOption-${rowOption.dwId}`">
            ...
            <tr class="dw-el-radio-checkbox-tr">
              <template v-for="(colOption, colIndex) in survey.questions[index].quCols">
                <td v-if="!colOption.tempEmptyOption" :key="`matrix-colOption-content-${colIndex}`" @click.stop="clickItem(rowOptionIndex,colIndex)">
