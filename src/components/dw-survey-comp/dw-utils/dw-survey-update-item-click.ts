 ...
 * @param callback
 */
export function clickItem (survey: any, itemIndex: number, callback: (survey: any, itemIndex: number) => void) {
 ...
 * @param callback
 */
export function clickQuItem (survey: any, itemIndex: number, quIndex: number | null, callback: (survey: any, itemIndex: number) => void) {
  /*
  // 组件内抽取的原代表片段
  if (this.itemIndex === 0) {
 ...
 * @param callback
 */
export function upAllItemClick (survey: any, itemClicks: number[], callback: (survey: any) => void) {
  /*
  // 组件内抽取的原代表片段
...
export function resetOtherClickItem (survey: any, quIndex: number) {
