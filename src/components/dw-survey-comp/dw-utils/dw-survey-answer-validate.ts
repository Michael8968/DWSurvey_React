...
export function validateQuestionsBoolBySurvey (survey: any) {
 ...
 * @returns {boolean}
 */
export function validateQuestionsBool (questions: any) {
  let isSuccess = true
  submitValidateQuestions(questions, true)
  questions.forEach((question: any, quIndex: number) => {
    if (question.showQu && !question.logicIsHide) {
...
export function submitValidateQuestions (questions: any, showOptionError: any) {
 ...
 * @param question
 */
function validateQuRadio (question: any) {
  const errorTexts = []
 ...
 * @param question
 */
function validateCheckbox (question: any) {
  const errorTexts = []
  const validateObj = question.validateObj
  let answerSize = 0
 ...
 * @param question
 */
function validateQuOrderbys (question: any) {
 ...
 * @param question
 */
function validateQuFbk (question: any) {
  const validateObj = question.validateObj
...
function validateAnswerInput (question: any, inputAttr: any, errorTexts: any, answerValue: any) {
 ...
 * @param question
 */
function validateQuMultiFillblanks (question: any) {
  const errorTexts = []
 ...
 * @param question
 */
function validateQuScores (question: any) {
 ...
 * @param question
 */
function validateQuUploadFile (question: any) {
  const validateObj = question.validateObj
  let answerSize = 0
 ...
 * @param question
 */
function validateQuMatrixRadio (question: any) {
  const validateObj = question.validateObj
 ...
 * @param question
 */
function validateQuMatrixCheckbox (question: any) {
  const validateObj = question.validateObj
  const quRows = question.quRows
  let answerSize = 0
 ...
 * @param question
 */
function validateQuMatrixInput (question: any) {
  const validateObj = question.validateObj
  let isAnswer = true
  const quRows = question.quRows
  quRows.map((rowOption: any, index: number) => {
    const rowCols = rowOption.rowCols
    rowCols.map((rowColOption: any, rowColIndex: number) => {
 ...
 * @param question
 */
function validateQuMatrixScale (question: any) {
  const validateObj = question.validateObj
  const quRows = question.quRows
  let answerSize = 0
