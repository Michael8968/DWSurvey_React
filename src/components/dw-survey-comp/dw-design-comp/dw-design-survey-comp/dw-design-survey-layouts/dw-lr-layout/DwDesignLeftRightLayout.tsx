...
import DwDesignToolbarTop from './dw-design-toolbar/DwDesignToolbarTop';
import DwDesignHeader from '../dw-tb-layout/comp/DwDesignHeader';
...
const DwDesignLeftRightLayout: React.FC<Props> = ({ value: survey, onChange }) => {
  ...
  const [containerLRStyle, setContainerLRStyle] = useState<StyleState>({ top: 110, index: 100 });
  const [lrContentHeight, setLrContentHeight] = useState(100);
  ...
  const onScroll = () => {
    ...
    if (scrollTop >= headerHeight) {
      ...
      setContainerLRStyle(prev => ({ ...prev, top: `${centerMarginTop}px` }));
      setLrContentHeight(window.innerHeight - centerMarginTop - lrUnContentHeight);
    } else {
      const newTop = headerHeight - scrollTop;
      setHeaderQuToolbarStyle(prev => ({ ...prev, top: `${newTop}px` }));
      const newTop2 = centerMarginTop + newTop;
      setContainerLRStyle(prev => ({ ...prev, top: `${newTop2}px` }));
      setLrContentHeight(window.innerHeight - newTop2 - lrUnContentHeight);
    }
  };
                    ...
                    <Row gutter={10} style={{ margin: 0 }}>
                      <Col span={4}>
                        <div
                          ...
                          className="dw-container-body-center-left dw-container-body-lr dw-container-body-lr-flex"
                        >
                      ...
                      <Col span={4}>
                        <div
                          ...
                          className="dw-container-body-center-right dw-container-body-lr dw-container-body-lr-flex"
                        >
...
export default DwDesignLeftRightLayout; 